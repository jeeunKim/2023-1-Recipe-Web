...
<header class="head">
		<ul id="menubar">
			...
			<c:if test = "${nickname != null}">
				<li><span><img class="icon" src="./profile2.png"></span>
	...
	<section class = "up">
		...
		<c:if test = "${nickname != null}">
			...
			<%= (String) session.getAttribute("owner_nickname")%>&nbsp님이 올린 다른 레시피</span>
			<a href ="Gosub2.do?owner_id=<%= owner_id %>" class="sub">구독하기</a>
		</c:if>
	...
	<c:forEach var="cnt" begin="1" end="${count}" step="1" varStatus="status">
		...
		<div class="card" >
		  ...
		  <div class="card-body">
			...
			<a href ="jjim.do?recipe_id=<%= recipe_id[many] %>" class="jjim">찜하기</a></h5> 
